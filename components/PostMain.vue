...
<img class="rounded-full max-h-[60px] " width="60" src="https://picsum.photos/id/8/320" alt="photo">
    </div>
    <div class="pl-3 w-full px-4 ">
        <div class="flex items-center justify-between pb-0.5">
            ...
            <div class="text-[14px] pb-0.5 flex items-center font-semibold">
                ...
                <div class="px-1">{{$t('original sound - AWESOME')}}</div>
                ...
                <div class="relative mr-[75px]">
                    <div class="absolute bottom-0 pl-2">
                        <div class="pb-4 text-center">
                           ...
                           <span class="text-xs text-gray-800 font-semibold">{{$t(34)}}</span>
                        </div>
                        <div class="pb-4 text-center">
                            <button class="rounded-full bg-gray-200 cursor-pointer"   >
